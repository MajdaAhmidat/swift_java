...
/**
 * Mapper PACS 009 → VirementRecu (flux reçu OUT_SAA).
 */
@Component
public class PACS009ToVirementRecuMapper {

    public VirementRecu toVirementRecu(MxPacs00900108 mx, Long nextIdVrtRecu,
