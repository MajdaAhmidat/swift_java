...
@Entity
@Table(schema = "swift", name = "virement_emis")
@IdClass(VirementEmis.VirementEmisPK.class)
public class VirementEmis {
    ...
    /** Statut SWIFT du virement : INTEGRE, ACK, NACK, etc. (colonne statut_swift) */
    @Column(name = "statut_swift", length = 50)
    ...
    /** MESSAGE_EMIS has_one VIREMENT_EMIS => VIREMENT_EMIS has_one MESSAGE_EMIS */
    @OneToOne(mappedBy = "virementEmis", cascade = CascadeType.ALL, orphanRemoval = true)
    private MessageEmis messageEmis;
    ...
    public Statut getStatutRef() { return statutRef; }
    public void setStatutRef(Statut statutRef) { this.statutRef = statutRef; }
    public Adresse getAdresse() { return adresse; }
    public void setAdresse(Adresse adresse) { this.adresse = adresse; }
    public Bic getBic() { return bic; }
    public void setBic(Bic bic) { this.bic = bic; }
    public MessageEmis getMessageEmis() { return messageEmis; }
    public void setMessageEmis(MessageEmis messageEmis) { this.messageEmis = messageEmis; }

    /** PK composite  */
    @Getter @Setter @NoArgsConstructor @AllArgsConstructor @EqualsAndHashCode
    public static class VirementEmisPK implements Serializable {
